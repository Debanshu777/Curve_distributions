...
from curve_distributions import Gaussian
from curve_distributions import Binomial
...
class TestBinomialClass(unittest.TestCase):
    def setUp(self) -> None:
        self.binomial :Binomial = Binomial(0.4, 20)
    ...
    def test_calculatemean(self) -> None:
        mean :float = self.binomial.calculate_mean()
        self.assertEqual(mean, 8)

    def test_calculatestdev(self) -> None:
